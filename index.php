      ...
      <div class="row">
        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane active" id="resentnewcar">
            ...
            <?php $sql = "SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
